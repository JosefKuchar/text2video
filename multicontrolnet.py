# /tmp/xkucha28/miniconda3/envs/gen/lib/python3.10/site-packages/diffusers/pipelines/controlnet/multicontrolnet.py
import os
...
class MultiControlNetModel(ModelMixin):
    ...
    def from_pretrained(
        ...
        logger.info(
            f"{len(controlnets)} controlnets loaded from {pretrained_model_path}."
        )
