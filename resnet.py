...
# /tmp/xkucha28/miniconda3/envs/gen/lib/python3.10/site-packages/diffusers/models/resnet.py
        ...
        ff_output = torch.cat(
            [
                ...
                for input_chunk, temb_chunk in zip(
                    input_tensor.chunk(num_chunks, dim=0), temb.chunk(num_chunks, dim=0)
                )
            ],
            dim=0,
        )
